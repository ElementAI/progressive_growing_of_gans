...
desc += '-ssense';             dataset = EasyDict(tfrecord_dir='/mnt_host/scratch/ssense/tf_record_ssense')
...
desc += '-preset-v2-8gpus'; num_gpus = 8; sched.minibatch_base = 32; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32}; sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.004, 1024: 0.004}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 18000
